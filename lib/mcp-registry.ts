...
export const MCP_REGISTRY: Record<string, McpServerConfig> = {
  ...
  google_docs: {
    ...
    transport: "http",
    description: "Read and write Google Docs documents via Google OAuth.",
  },
  google_drive: {
    name: "Google Drive",
    qualifiedName: "@markuspfundstein/mcp-gsuite",
  ...
  google_slides: {
    ...
    transport: "http",
    description: "Create and update Google Slides presentations via Google OAuth.",
  },
  google_search_console: {
    name: "Google Search Console",
    qualifiedName: "@ahonn/mcp-server-gsc",
    url: "https://server.smithery.ai/@ahonn/mcp-server-gsc/mcp",
    credentialType: "oauth_google",
    oauthScopes: [
      "https://www.googleapis.com/auth/webmasters.readonly",
    ],
    transport: "http",
    description: "Query search performance data from Google Search Console.",
  },
  google_analytics: {
    name: "Google Analytics",
    qualifiedName: "@ruchernchong/mcp-server-google-analytics",
    url: "https://server.smithery.ai/@ruchernchong/mcp-server-google-analytics/mcp",
    credentialType: "oauth_google",
    oauthScopes: [
      "https://www.googleapis.com/auth/analytics.readonly",
    ],
    transport: "http",
    description: "Query GA4 metrics and dimensions.",
  },
  airtable: {
    name: "Airtable",
  ...
  outlook: {
    name: "Outlook",
    qualifiedName: "@softeria/ms-365-mcp-server",
    url: "https://server.smithery.ai/@softeria/ms-365-mcp-server/mcp",
    credentialType: "oauth",
    transport: "http",
    description: "Read and send Outlook emails and manage calendar. Requires Microsoft OAuth.",
  },
  microsoft_teams: {
    ...
    credentialType: "oauth",
    transport: "http",
    description: "Post messages and manage Microsoft Teams channels. Requires Microsoft OAuth.",
  },
  excel: {
    name: "Excel",
    qualifiedName: "@softeria/ms-365-mcp-server",
    ...
    credentialType: "oauth",
    transport: "http",
    description: "Read and write Microsoft Excel workbooks. Requires Microsoft OAuth.",
  },
  sharepoint: {
    name: "SharePoint",
    qualifiedName: "@softeria/ms-365-mcp-server",
    ...
    credentialType: "oauth",
    transport: "http",
    description: "Access SharePoint lists, libraries and sites. Requires Microsoft OAuth.",
  },
  confluence: {
    name: "Confluence",
  ...
  databox: {
    name: "Databox",
    qualifiedName: "databox",
    url: "https://mcp.databox.com/mcp",
    credentialType: "oauth",
    transport: "http",
    description: "Push and query metrics from Databox dashboards. Requires Databox OAuth.",
  },
};
