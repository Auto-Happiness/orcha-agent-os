import { Grid, TextInput, PasswordInput, Checkbox } from "@mantine/core";
import { IconLock } from "@tabler/icons-react";
import { inputStyles } from "@/lib/styles";
import { useCreationWizard } from "@/lib/store/useCreationWizard";

export function MariaDBForm() {
    ...
    <Grid>
      <Grid.Col span={{ base: 12, sm: 8 }}>
        <TextInput 
          ...
          placeholder="e.g. mariadb-prod.db.internal" 
          styles={inputStyles} 
          value={dbConfig.host || ""}
      ...
      <Grid.Col span={12}>
        <Checkbox 
          ...
          description="Required for most cloud providers (DigitalOcean, AWS RDS, etc.)"
          color="teal"
